...
{
    /// <inheritdoc />
    public partial class RecreateTablesWithUpperCase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // 1. Dropar tabelas existentes (tentando ambos os formatos)
            ...
            // 2. Recriar tabelas em maiúsculas (padrão Oracle) - apenas se não existirem
            migrationBuilder.Sql(@"
                BEGIN
